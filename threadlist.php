...
<?php  include 'partials/_dbconnect.php'; ?>
    ...
    if($method=='POST'){
      ...
      $th_desc =str_replace(">","&gt;" , $th_desc);
      $sno = $_POST['sno'];
      $sql="INSERT INTO `threadss` ( `thread_title`, `thread_desc`, `thread_cat_id`, `thread_user_id`, `timestamp`) VALUES ( '$th_title', '$th_desc' , '$id' ,'$sno' , current_timestamp())";
      $result=mysqli_query($conn , $sql);
      $showAlert=true;
      if($showAlert){
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Success!</strong> Your thread has been added.Plase wait to community respond
...
Stay on the topic of the thread – do not stray.
  ...
  <div class="form-group">
    ...
    <small id="emailHelp" class="form-text text-muted">
      Keep your concern short and crisp as possible
    </small>
  </div>
  <div class="form-group">
  ...
  <button type="submit" class="btn btn-success">Submit</button>
   ...
   echo '<div class="container">
   <h1 class="py-2" >Start a Discussion</h1>
   <p class="lead">You are not logged in.Please to be able to start a discussion </p>
 </div>';
